...
_Generated: 2026-06-10T15:45:47.211Z_
...
Workspace `mcp.json` _(folder: pdf)_

- **c:\Users\noby\Noby's Projects\pdf\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\noby\.claude.json** — _File exists — no servers defined_
...
- **skill-creator** — `C:\Users\noby\.claude\skills\skill-creator`
